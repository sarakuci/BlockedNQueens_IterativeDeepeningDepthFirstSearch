    ...
    public class Queen
    {
        ...
        public Queen(int nr) //Konstruktori i klases Queen
        {
            ...
            for (int k = 0; k < bp; k++)
            {
                ...
                Board[i, j] = 2; //Override i tabeles ku do te vendoset vlera 2, pra mbishkruhet 2 ne vend te 0.
            }
        }
        //Specifikimi i levizjeve te mbretereshes -- Implementimi i Iterative-Deepening-Depth-First Search
        public bool SafeMov(int row, int column, int max_depth = 10)
        {
            int i, j;
